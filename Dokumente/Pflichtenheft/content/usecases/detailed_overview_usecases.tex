...
\begin{document}
    ...
    \subfile{./content/usecases/UseCase_ReservierungAendern.tex}
    \subfile{./content/usecases/UseCase_ReservierungOptionen.tex}
    \subfile{./content/usecases/UseCase_ZwischenrechnungErstellen.tex}
