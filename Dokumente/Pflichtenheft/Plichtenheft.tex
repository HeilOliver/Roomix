...
\begin{document}
    ...
    \chapter{Einführung}
    \section{System}
        \subfile{./content/system/SystemKurzbeschreibung.tex}
    \section{Zweck}
        \subfile{./content/system/SystemZweck.tex}
    \section{Umfang}
        \subfile{./content/system/SystemUmfang.tex}
    \section{Referenzen}
        \subfile{./content/system/SystemReferenzen.tex}
    \section{Überblick}
        \subfile{./content/system/SystemUeberblick.tex}
    ...
    \subsection{Usability der Benutzeroberfläche}
    Für den Client wird eine grafische Oberfläche basierend auf JavaFX entwickelt.
    \subsection{Anwendung}
    Durch Java wird eine Plattformunabhängigkeit gewährleistet. Zudem wird eine 'Fat-Client' Architektur vewendet.
    Bei der 'Fat-Client' Architektur liegt die Anwendungslogik auf der Clientseite. Dadurch werden Hardwareanforderungen
    auf der Serverseite minimiert.
    \subsection{Datenbank}
    Als Datenbanksystem wird MySQL verwendet. Diese Datenbank wird in einem Dockers Container auf dem Server ausgeführt.
    \subsection{Netzwerk}
    Für die Unterstützung multipler Clients und um den Zugriff auf die Datenbank zu gewährleisten wird ein TCP/IP-basierendes Netzwerk benötigt.
    Jeder Client muss eine Verbindung zum Server herstellen können.
    \subsection{Drucker}
    Für das Ausdrucken von Rechnungen jeder Art, Reports und so weiter wird ein Drucker benötigt. Dieser kann
    wahlweise per USB oder im Netzwerk eingebunden sein.
    ...
    \subfile{./content/model_classes/hotel.tex}
    \subfile{./content/model_classes/reisebüro.tex}
    \subfile{./content/model_classes/unternehmen.tex}
    \subfile{./content/model_classes/person.tex}
    \subfile{./content/model_classes/gast.tex}
    \subfile{./content/model_classes/gruppe.tex}
    \subfile{./content/model_classes/saison.tex}
    \subfile{./content/model_classes/extraleistung.tex}
    \subfile{./content/model_classes/zusatzleistung.tex}
    \subfile{./content/model_classes/rechnungsposition.tex}
    \subfile{./content/model_classes/option.tex}
    ...
    \section{Überblick}
        \subfile{./content/usecases/overview.tex}
    ...
    \begin{figure}[ht!]
        \begin{center}
            \rotatebox{-1}{\includegraphics[width=0.8\textheight,angle=-269]{./assets/ObjectLivecycle_Reservierung.png}}
    ...
    \begin{figure}[ht!]
        \begin{center}
            \rotatebox{-1}{\includegraphics[width=0.8\textheight,angle=-89]{./assets/ObjectLivecycle_Zimmerstatus.png}}
    ...
    \section{Copyright und andere rechtliche Anforderungen}
        \subfile{./content/nonfunktionaleAnforderungen/CopyrightUndAndereRechlicheAnforderungen.tex}
